 ...
 */
 ...
 async function startViewer(localView, remoteView, onStatsReport, onRemoteDataMessage) {
     ...
     const kinesisVideoClient = new AWS.KinesisVideo({
         region: "us-west-2",
         accessKeyId: "AKIA2NG6J3S6FFY4QFO4",
         secretAccessKey: "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",
         sessionToken: null,
         endpoint: null,
     ...
     const describeSignalingChannelResponse = await kinesisVideoClient
         .describeSignalingChannel({
             ChannelName: "air-quality-website-stream",
         })
         .promise();
     ...
     viewer.signalingClient = new KVSWebRTC.SignalingClient({
         ...
         clientId: (function getRandomClientId() {
            return Math.random()
                .toString(36)
                .substring(2)
                .toUpperCase();
     ...
     viewer.signalingClient.on('open', async () => {
         ...
         if (true || false) {
             try {
                 // This is where I connect to TouchDesigner... but how??
